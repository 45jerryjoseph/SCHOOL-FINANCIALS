            ...
            <div className="card mask-custom">
              <div className="card-body p-4 text-black">
                <div className=" pt-3 pb-2">
                  <h2 className="my-4 text-center text-4xl italic">Finances</h2>
                ...
                <table className="table text-black w-full  mb-0 border border-slate-500 ">
                  <thead className=' bg-cyan-300 ' >
                    <tr>
                      ...
                      <th   className=' border border-slate-500'>Total Fee</th>
                      <th   className=' border border-slate-500'>Paid Amount</th>
                      <th   className=' border border-slate-500'>Active Balance</th>
                      <th   className=' border border-slate-500'>Action</th>
                      </tr>
                  </thead>
                  <tbody >
                   <tr>
                      <td   className=' border border-slate-500'>Reg No</td>
                      <td   className=' border border-slate-500'>Total Fee</td>
                      <td   className=' border border-slate-500'>Paid Amount</td>
                      <td   className=' border border-slate-500'>Active Balance</td>
